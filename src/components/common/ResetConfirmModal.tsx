    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-xl">
      <div className="apple-card rounded-2xl max-w-md w-full p-6 shadow-2xl text-left">
        ...
        <p className="text-xs text-white/60 leading-relaxed mb-5">
          This will wipe all active venture data, autonomous agents, revenue, technical debt, and milestones, returning you to the venture creation screen.
        </p>

        <div className="flex items-center justify-end gap-2.5">
          <button
            onClick={onClose}
            className="px-4 py-1.5 rounded-xl apple-btn-secondary text-xs font-medium text-white/80 transition-all"
          >
            Cancel
          </button>
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-1.5 rounded-xl bg-[#ff453a] hover:bg-[#e0382e] text-xs font-medium text-white transition-all shadow-sm"
          >
